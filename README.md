...
### Ссылки для проверки
- Получение списка заметок: http://37.230.117.32:8083/api/v1/notes?limit=5
- Текстовый поиск: http://37.230.117.32:8083/api/v1/notes?q=тест4
- Статистика: http://37.230.117.32:8083/api/v1/notes/stats
